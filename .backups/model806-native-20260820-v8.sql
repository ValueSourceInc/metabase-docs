...
dec AS (
  SELECT id, flag, lede,
    ...
    CASE WHEN flag IN ('MIRROR','MIRROR_LAG') THEN GREATEST(cibw-uibw,0) ELSE cibw END AS a_ibw,
    CASE WHEN flag IN ('MIRROR','MIRROR_LAG') THEN GREATEST(cibs-uibs,0) ELSE cibs END AS a_ibs,
    CASE WHEN flag IN ('MIRROR','MIRROR_LAG') THEN GREATEST(cibr-uibr,0) ELSE cibr END AS a_ibr,
