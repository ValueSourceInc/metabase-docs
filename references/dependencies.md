...
| #733 | Reports Customer Returns Data Model |  | #744 Sellable Quantity from Returns By SKU X Order, #781 Overall Refund Rate Over Time, #782 Return Reason is Color By Product, #783 Return Parent ASIN Pie, #784 Return Rate By SKU, #785 Return Reason Pie, #786 Returns By Disposition Type, #787 Return SKU Pie, #788 Returns Reason Pivot, #789 Sellable Quantity from Returns By SKU X Order, #928 按SKU全摊薄已售经营表现底表, #961 Return By Color By Product |  |
...
| #928 | 按SKU全摊薄已售经营表现底表 | #733 Reports Customer Returns Data Model, #806 库存表, #904 Sold Operating Performance Source (已售经营表现底表) | #929 Cumulative Sold Operating Performance (累计已售经营表现), #932 Cumulative Sold Operating ROI Trend (累计已售经营ROI趋势), #933 Allocated Cost Structure Source (按SKU已分摊成本结构底表), #935 Cumulative Cost Structure (累计成本结构), #938 Monthly Sold Operating ROI Trend (月度已售经营ROI趋势), #939 Monthly Sold Operating ROI MoM Change (月度已售经营ROI环比变化), #940 Cumulative Net Profit Ranking (累计净利排行), #942 透视图例子111, #943 Monthly Cost-to-Sales Ratio Source (月度成本占销售额比率底表), #969 Cost & Net Profit Structure Source (成本与净利润结构底表) |  |
...
| #795 | 出售地区 US | #776 Reports Flat File All Orders Data By Order Date General Hourly Model |  | Sales Dashboard, Store Monitor Dashboard |
| #835 | VS 箱单 By SKU | #836 Shipment Pricing Model (UI) | #837 VS 箱单 By Product Group | VS 箱单 |
| #852 | 出售地区 CA | #776 Reports Flat File All Orders Data By Order Date General Hourly Model |  | Sales Dashboard, Store Monitor Dashboard |
| #874 | 产品订单曲线 Per SKU (NO VINE) | #776 Reports Flat File All Orders Data By Order Date General Hourly Model |  | Sales Dashboard, 补货面板 |
| #876 | Wps Sales Forecast By Day |  | #878 备货发货 Forecast WOS Summary, #879 未来有效日销model |  |
| #877 | 发货基础表 | #776 Reports Flat File All Orders Data By Order Date General Hourly Model, #806 库存表, #870 SKU First Sale Date, #954 30 Days Sales (IQR Denoised) | #878 备货发货 Forecast WOS Summary, #879 未来有效日销model |  |
| #901 | 工厂补货表2.0 | #873 补货 FBA Total Inventory Chart 2.0 | #960 工厂下单 Color Size Sales Weighted Mix | 补货面板 |
...
| #920 | 产品订单曲线 Cum Sales QTY Per SKU (NO VINE) | #776 Reports Flat File All Orders Data By Order Date General Hourly Model |  | Sales Dashboard, 补货面板 |
...
| #782 | Return Reason is Color By Product | #733 Reports Customer Returns Data Model |  | Returns |
...
| #807 | 30 Days Sales | #776 Reports Flat File All Orders Data By Order Date General Hourly Model | #811 补货 Fulfillable Inventory Chart |  |
...
| #899 | Wps Shipment Model |  | #878 备货发货 Forecast WOS Summary |  |
| #900 | Wps Shipment Items Model |  | #878 备货发货 Forecast WOS Summary |  |
...
| #935 | Cumulative Cost Structure (累计成本结构) | #928 按SKU全摊薄已售经营表现底表 |  | Cost (成本看板) |
...
| #943 | Monthly Cost-to-Sales Ratio Source (月度成本占销售额比率底表) | #928 按SKU全摊薄已售经营表现底表 | #949 Cost Pivot Table by Store & Marketplace (按店铺成本透视表) |  |
| #948 | Monthly Cost-to-Sales Ratio (月度成本和净利占销售额比率曲线) | #969 Cost & Net Profit Structure Source (成本与净利润结构底表) |  | Cost & Net Profit Dashboard (成本与净利润看板) |
| #949 | Cost Pivot Table by Store & Marketplace (按店铺成本透视表) | #943 Monthly Cost-to-Sales Ratio Source (月度成本占销售额比率底表) |  | Cost (成本看板) |
| #950 | 下单量 |  |  | 补货面板 |
| #954 | 30 Days Sales (IQR Denoised) | #776 Reports Flat File All Orders Data By Order Date General Hourly Model | #877 发货基础表 |  |
| #958 | Quantity Sold By Color | #776 Reports Flat File All Orders Data By Order Date General Hourly Model |  | Sales Dashboard |
| #959 | Quantity Sold By Sizes | #776 Reports Flat File All Orders Data By Order Date General Hourly Model |  | Sales Dashboard |
| #961 | Return By Color By Product | #733 Reports Customer Returns Data Model |  | Returns |
| #966 | Quantity Sold By SKU X Marketplace | #776 Reports Flat File All Orders Data By Order Date General Hourly Model |  | Sales Dashboard |
| #970 | Monthly Cost-to-Sales Ratio (月度成本和净利占销售额比率柱状图) | #969 Cost & Net Profit Structure Source (成本与净利润结构底表) |  | Cost & Net Profit Dashboard (成本与净利润看板) |
| #972 | Cost & Net Profit % of Sales Pivot (成本与净利占销售额比透视表) | #969 Cost & Net Profit Structure Source (成本与净利润结构底表) |  | Cost & Net Profit Dashboard (成本与净利润看板) |
